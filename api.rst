...
Search results are by default sorted on the basis of relevance score. Results can be sorted on the basis of any other criteria such \� alphabetical sort on name or sort by age descending.
