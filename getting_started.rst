...
Create Engine
-------------
The very first step to get started with dataQuir – Easy Search & Engagement Service is to create a `Search & Engagement Engine` for your application.
...
**Note**
	...
	* A multivalued field is required when there are more than one value present for the field, e.g. movie_gere, there can be multiple genres associated with a movie. 
...
Your
	* Search API: /dq-api/engines/<your-search-engine-id>/search?q=<query string>
	* Auto-complete API: /dq-api/engines/<your-search-engine-id>/search?q=<query string>
